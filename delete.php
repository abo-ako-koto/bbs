...
if( !empty($_GET['message_id']) && empty($_POST['message_id'])){
    ...
    if( empty($error_message) ) {
        ...
        if( $mysqli->connect_errno ) {
            ...
            // UPDATE文で更新 WHERE句に投稿IDを指定して更新する投稿データを検索
...
<div>
    ...
    <?php if( !empty($message_data['view_name']) ){ echo $message_data['view_name']; } ?>" disabled>
...
<div>
    ...
    <!-- 編集した内容を登録するときに内容を更新する投稿が分かるよう投稿IDをフォームにセット -->
    <!-- 編集することの無いように、input要素のtype属性を「hidden」-->
